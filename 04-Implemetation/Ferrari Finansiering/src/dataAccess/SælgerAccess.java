...
public class SælgerAccess {
	...
	public void createSælgernavn(Connection connection, Sælger sælger)
			throws SQLException {
	...
	public Sælger readSælgernavn(Connection connection, int sælgerid)
			throws SQLException {
		PreparedStatement statement = null;
	...
	public void updateSælger(Connection connection, Sælger sælger)
			throws SQLException {
		PreparedStatement statement = null;
		try {
	...
	public void deleteSælger(Connection connection, int sælgerid)
			throws SQLException {
		PreparedStatement statement = null;
		try {

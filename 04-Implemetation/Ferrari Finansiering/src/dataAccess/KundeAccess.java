...
public class KundeAccess {
	...
	public void createKunde(Connection connection, Kunde kunde)
			throws SQLException {
		PreparedStatement statement = null;
		PreparedStatement statement1 = null;
		ResultSet resultset = null;
		try {
			statement1 = connection.prepareStatement(INSERTCPRNUMMER,
	...
	public String readCprnummer(Connection connection, int cprid)
			throws SQLException {
		PreparedStatement statement = null;
		ResultSet resultset = null;
		try {
	...
	public Kunde readKunde(Connection connection, String cprnummer)
			throws SQLException {
		PreparedStatement statement = null;
		ResultSet resultset = null;
		Kunde kunde = null;
	...
	public Kunde readKunde(Connection connection, int cprid)
			throws SQLException {
		PreparedStatement statement = null;
		ResultSet resultset = null;
		Kunde kunde = null;
	...
	public List<Kunde> listKunder(String searchitem, String search)
			throws SQLException {
		Connection connection = null;
		try {
			connection = new DbConnection().getConnection();
	...
	public List<Kunde> listKunder(Connection connection, String searchitem,
			String search) throws SQLException {
		PreparedStatement statement = null;
		ResultSet resultset = null;
		List<Kunde> list = new ArrayList<>();
		try {
			String SEARCH = "SELECT cprid ,navn, adresse, postnummer, telefonnummer, email, kommentar FROM kunde where "
					+ searchitem + " LIKE ?";
	...
	public void updateKunde(Connection connection, Kunde kunde)
			throws SQLException {
		PreparedStatement statement = null;
		try {
	...
	public void deleteCprnummer(Connection connection, int cprid)
			throws SQLException {
		PreparedStatement statement = null;
		try {

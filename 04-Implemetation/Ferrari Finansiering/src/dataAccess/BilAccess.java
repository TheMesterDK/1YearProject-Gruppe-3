...
public class BilAccess {
	...
	public Bil readBil(Connection connection, String chassisnummer)
			throws SQLException {
		PreparedStatement statement = null;
		...
		try {
			...
			while (resultset.next()) {
				bil.setRegistreringsnummer(resultset
						.getString("registreringsnummer"));
	...
	public List<Bil> listBiler(String searchitem, String search)
			throws SQLException {
		Connection connection = null;
		try {
			connection = new DbConnection().getConnection();
	...
	public List<Bil> listBiler(Connection connection, String searchitem,
	...
	public void deleteBil(Connection connection, String chassisnummer)
			throws SQLException {
		PreparedStatement statement = null;
		try {

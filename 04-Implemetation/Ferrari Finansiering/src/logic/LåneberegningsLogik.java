...
public class LåneberegningsLogik {
	...
	public Finansieringsaftale beregnTilbud(String kreditværdighed,
			Finansieringsaftale aftale) {
	...
	private double beregnRente(String kreditværdighed,
			Finansieringsaftale aftale) {
	...
	private double beregnAfdragsbeløb(Finansieringsaftale aftale) {
		double afdragsbeløb = ((aftale.getBeløb()
				+ aftale.getEkstraomkostninger() - aftale.getUdbetaling()) * ((rente / 100) / 12))
				/ (1 - Math.pow(1 + ((rente / 100) / 12),
						-aftale.getAfviklingsperiode()));
		return afdragsbeløb;
	}
	...
	private double beregnÅOP(Finansieringsaftale aftale) {
		double åop = (((aftale.getAfdragsbeløb() * aftale
				.getAfviklingsperiode()) - aftale.getBeløb()) / aftale
				.getBeløb())
				/ (aftale.getAfviklingsperiode() * 12);
		// double åop = (100 *
		// (((aftale.getAfdragsbeløb()*aftale.getAfviklingsperiode()) -
		// aftale.getBeløb()) / aftale.getBeløb()));
		return åop;
	}

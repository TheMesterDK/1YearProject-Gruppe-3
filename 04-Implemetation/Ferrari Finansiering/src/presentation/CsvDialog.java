...
{  
  ...
  public CsvDialog(Finansieringsaftale aftale)
  {
    ...
    JButton btnEksporterLnetilbudTil = new JButton("Eksporter lånetilbud til Csv-fil");
    contentPanel.add(btnEksporterLnetilbudTil);
    btnEksporterLnetilbudTil.addActionListener( event ->
    {
      CsvLogik csvl = new CsvLogik();
      csvl.writeCsvFile( aftale, stedField.getText(), navnField.getText() );
      this.dispose();
    });
